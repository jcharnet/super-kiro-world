...
function renderLevelComplete(ctx) {
    ...
    if (currentLevel === 2) {
        ...
        ctx.fillText('All Levels Complete!', CANVAS_WIDTH / 2, CANVAS_HEIGHT / 2 - 60);
    } else {
        ctx.fillStyle = '#00ff00';
        ctx.font = 'bold 48px Courier New';
        ctx.textAlign = 'center';
    ...
    ctx.fillText(`Time: ${timeTaken}s`, CANVAS_WIDTH / 2, CANVAS_HEIGHT / 2 + 5);
    ctx.fillText(`Score: ${score}`, CANVAS_WIDTH / 2, CANVAS_HEIGHT / 2 + 30);
    ctx.fillText(`Collectibles: ${score} / ${totalCollectibles}`, CANVAS_WIDTH / 2, CANVAS_HEIGHT / 2 + 55);
    ctx.fillText(`Lives Remaining: ${lives}`, CANVAS_WIDTH / 2, CANVAS_HEIGHT / 2 + 80);
    
    ctx.font = '24px Courier New';
    ctx.fillText('Press R to Replay', CANVAS_WIDTH / 2, CANVAS_HEIGHT / 2 + 120);
    
    if (!window.scoreSubmitted) {
        ctx.font = '16px Courier New';
        ctx.fillStyle = '#790ECB';
        ctx.fillText('Score saved to leaderboard!', CANVAS_WIDTH / 2, CANVAS_HEIGHT / 2 + 150);
    }
